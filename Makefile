INCLUDES:=includes
VPATH:=srcs:srcs/init:srcs/quit:srcs/camera:srcs/interval:srcs/ray:srcs/rendering:srcs/objects:srcs/events:srcs/array:srcs/parser:srcs/random:srcs/time:srcs/utils
